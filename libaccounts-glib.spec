...
Source0:	https://gitlab.com/accounts-sso/libaccounts-glib/repository/archive.tar.bz2
...
%prep
%setup -qn %{name}-VERSION_%{version}-00254a604a7c7bd38c41794a80ad8930e90f21aa
./autogen.sh
